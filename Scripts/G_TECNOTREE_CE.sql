CREATE OR REPLACE PACKAGE G_TECNOTREE_CE AS 
  ...
  * actual.
  */
  PROCEDURE P_CALCULAR_SUMARIZACIONES_TEC(P_FECHA IN VARCHAR2);
END G_TECNOTREE_CE;
/
...
CREATE OR REPLACE PACKAGE BODY G_TECNOTREE_CE AS 
  ...
  */
  ...
  --
  PROCEDURE P_CALCULAR_SUMARIZACIONES_TEC(P_FECHA IN VARCHAR2)AS
  BEGIN
    NULL;
  END P_CALCULAR_SUMARIZACIONES_TEC;
  --
END G_TECNOTREE_CE;
/
